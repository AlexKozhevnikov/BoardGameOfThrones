...
public class Constants {
    ...
    public static final String UNKNOWN_EVENT = "Неизвестное событие";
    public static final String UNKNOWN_ORDER = "Неизвестный приказ";
    public static final String UNKNOWN_UFO = "Неизвестное нечто";
