...
public class Constants {
    ...
    public static final int FIGHT_INDENT = 5;
    public static final int FIGHT_SMALL_X_INDENT = 1;
    public static final int FIGHT_TEXT_Y_INDENT = 22;
    public static final int FIGHT_STRING_TEXT_Y_INDENT = 30;
    public static final int FIGHT_SPECIFICS_Y = 434;
    public static final int FIGHT_FINAL_TEXT_Y = 520;
    public static final int SWORD_ICON_HEIGHT = 31;
    public static final int FIGHT_FINAL_SWORD_Y = FIGHT_FINAL_TEXT_Y - (int) (SWORD_ICON_HEIGHT * 0.9);
